          ...
          {step === 4 && (
            <section style={{textAlign:'center'}}>
              ...
              <div className="register-cta">
                ...
                <p>This is exactly what your clients experience with their own booking link.</p>
                <a href="https://studiodesk.store" className="btn btn-solid">Get StudioDesk for your business →</a>
              </div>
